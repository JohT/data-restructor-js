var e=globalThis,r={},t={},n=e.parcelRequirec1f2;null==n&&((n=function(e){if(e in r)return r[e].exports;if(e in t){var n=t[e];delete t[e];var o={id:e,exports:{}};return r[e]=o,n.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,r){t[e]=r},e.parcelRequirec1f2=n);var o=n.register;o("dED0n",function(e,r){//https://developer.mozilla.org/de/docs/Web/JavaScript/Reference/Global_Objects/Array/indexOf#Polyfill
if(!Array.prototype.indexOf){var t,n,o;Array.prototype.indexOf=(t=Object,n=Math.max,o=Math.min,function(e,r){if(this===null||void 0===this)throw TypeError("Array.prototype.indexOf called on null or undefined");var i=t(this),a=i.length>>>0,l=o(0|r,a);if(l<0)l=n(0,a+l);else if(l>=a)return -1;if(void 0===e){for(;l!==a;++l)if(void 0===i[l]&&l in i)return l;// undefined
}else if(e!=e){for(;l!==a;++l)if(i[l]!=i[l])return l;// NaN
}else for(;l!==a;++l)if(i[l]===e)return l;// all else
return -1;// if the value was not found, then return -1
})}}),o("b1M0n",function(e,r){//http://tokenposts.blogspot.com/2012/04/javascript-objectkeys-browser.html
Object.keys||(Object.keys=function(e){if(e!==Object(e))throw TypeError("Object.keys called on a non-object");var r,t=[];for(r in e)Object.prototype.hasOwnProperty.call(e,r)&&t.push(r);return t})}),o("ds403",function(e,r){var t,o=i(o);// Fallback for vanilla js without modules
...
a.internalCreateIfNotExists=i;var l=l||n("ccQZb");// supports vanilla js & npm
...
var i=o.replace(t,"");return{group:o,groupWithoutArrayIndices:i,name:n}}(n)).name&&"fieldName"!==i&&(e[o.groupWithoutArrayIndices+i]=e[o.group+"value"]);return e}(this.resolvableFieldsOfAll(this.sourceDataObject)))},/**
   ...
   * @protected
   * @memberof module:template_resolver.Resolver
   */(function(e,r,t){var n,o;for(n=0;n<e.length;n+=1)o=e[n],"function"==typeof t&&t(o.name)&&(r[o.name]=o.value)})(l.flattenToArray(arguments[e],3),r,t);return r},/**
     ...
     */this.replaceResolvableFields=function(e,r){var t=e,n=Object.keys(r),o=0,i="",a="";for(o=0;o<n.length;o+=1)a=r[i=n[o]],t=t.replace("{{"+i+"}}",a);return t}})}),o("ccQZb",function(e,r){/**
 ...
 */(($8e2fb4eb18d4597b$var$module||{}).exports={}).flattenToArray=function(e,r){var t=[];return("number"!=typeof r||r<1)&&(r=20),function e(n,o,i){if(!(i>r)&&"function"!=typeof n){if(Object(n)!==n)t.push({name:o,value:n});else if(Array.isArray(n)){var a,l=n.length;for(a=0;a<l;a+=1)e(n[a],o+"["+a+"]",i+1);0===l&&(t[o]=[],t.push({name:o,value:""}))}else{var f,u=!0;for(f in n)u=!1,e(n[f],o?o+"."+f:f,i+1);u&&o&&t.push({name:o,value:""})}}}(e,"",0),t}}),n("dED0n"),n("b1M0n");var i=n("ds403");module.exports={template_resolver:i};//# sourceMappingURL=templateResolver-ie.js.map
